...
export default {
  ...
  methods: {
    ...
    touchStart(ev) {
      ev = ev || event;
      ev.preventDefault();
      let canvasBox = document.getElementsByTagName("canvas")[0];
      this.h = canvasBox.offsetTop;
      this.w = canvasBox.offsetLeft;
      if (ev.touches.length == 1) {
        let obj = {
          x: ev.targetTouches[0].clientX - this.w,
          y: ev.targetTouches[0].clientY - this.h
        };
        this.startX = obj.x;
        this.startY = obj.y;
